...
class FileScanner:
    ...
    def __init__(
        ...
        self._exclude_patterns = list(self.exclude_globs)
        ...
        for pattern in self._exclude_patterns:
            ...
            if pattern.endswith("/**"):
                ...
                if rel_path_normalized.startswith(dir_pattern + "/") or rel_path_normalized == dir_pattern:
                    return pattern
            elif fnmatch.fnmatch(rel_path_normalized, pattern) or fnmatch.fnmatch(Path(rel_path_normalized).name, pattern):
                return pattern
